...
,'Progetto interno', 'Formazione', 'Call HR buddy', 'Organizzazione area', 'Task interno', 'Evento', 'Business proposal', 'Preventivo', 'Prima call lead', 'Call follow-up lead', 'Lead generation', 'Risposta mail cliente']
